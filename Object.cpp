...
void Particle::update(double epsilon) {
  ...
  vect<> netF = force; //normalF + shearF + force;
  ...
  torque = 0;
  force = 0; // normalF = shearF = force = Zero;
}
