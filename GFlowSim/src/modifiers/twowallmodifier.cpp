...
namespace GFlowSimulation {
  ...
  TwoWallModifier::TwoWallModifier(GFlow *gflow) : Modifier(gflow), max_distance(-1.), min_distance(-1.), acceleration(50.) {
    // Create the walls.
  ...
  TwoWallModifier::TwoWallModifier(GFlow *gflow, const Group& group1, const Group& group2) : Modifier(gflow), max_distance(-1.), 
