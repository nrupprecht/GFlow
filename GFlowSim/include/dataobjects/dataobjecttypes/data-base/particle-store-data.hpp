...
namespace GFlowSimulation {
  ...
  public:
    ...
    void add_vector_data_entry(const string&);

    //! \brief Request to store the magnitude of a vector data entry.
    void add_magnitude_data_entry(const string&);

    //! \brief Request to store a scalar data entry.
    void add_scalar_data_entry(const string&);

    //! \brief Request to store an integer data entry.
    void add_integer_data_entry(const string&);
