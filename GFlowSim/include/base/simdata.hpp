...
class SimData : public Base, public TimedObject {
 public:
  ...
  template<unsigned= 0>
  int addParticle(const real *, const real *, const real, const real, const int);
  ...
  real *X(const int);
  template<unsigned= 0>
  real &X(const int, const int);
  template<unsigned= 0>
  vec_access V();
  template<unsigned= 0>
  real *V(const int);
  template<unsigned= 0>
  real &V(const int, const int);
  template<unsigned= 0>
  vec_access F();
  template<unsigned= 0>
  real *F(const int);
  template<unsigned= 0>
  real &F(const int, const int);

  template<unsigned= 0, bool= true>
  ...
  int getVectorData(const string &);
  int getScalarData(const string &);
  int getIntegerData(const string &);
