#include <bonded/harmonic-chain.hpp>

using namespace GFlowSimulation;

HarmonicChain::HarmonicChain(GFlow *gflow)
    : Bonded(gflow), springConstant(DEFAULT_SPRING_CONSTANT) {};

HarmonicChain::HarmonicChain(GFlow *gflow, RealType K)
    : Bonded(gflow), springConstant(K) {};
