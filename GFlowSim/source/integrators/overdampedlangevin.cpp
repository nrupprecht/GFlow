...
OverdampedLangevinIntegrator::OverdampedLangevinIntegrator(GFlow *gflow)
    : LangevinTypeIntegrator(gflow, 1., DEFAULT_VISCOSITY) {};

OverdampedLangevinIntegrator::OverdampedLangevinIntegrator(GFlow *gflow, RealType temp)
    : LangevinTypeIntegrator(gflow, temp, DEFAULT_VISCOSITY) {};
