...
LangevinIntegrator::LangevinIntegrator(GFlow *gflow)
    : LangevinTypeIntegrator(gflow, 0.025, DEFAULT_VISCOSITY) {};

LangevinIntegrator::LangevinIntegrator(GFlow *gflow, RealType temp)
