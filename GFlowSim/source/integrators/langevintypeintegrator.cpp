#include "integrators/langevintypeintegrator.hpp"

using namespace GFlowSimulation;

LangevinTypeIntegrator::LangevinTypeIntegrator(GFlow *gflow, RealType T, RealType vis)
    : Integrator(gflow), viscosity(vis),
